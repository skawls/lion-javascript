...
// console.log( first.className = 'second'); // getter
...
first.classList.toggle('is--active'); //boolean 값 변환
...
// first.computedStyleMap.backgroundColor = 'orange'; // setter
// console.log( first.computedStyleMap.backgroundColor); //getter
